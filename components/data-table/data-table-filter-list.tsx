      ...
      case "number":
        return (
          <Input
            ...
            placeholder={filterField.placeholder ?? "Бичих..."}
        ...
        return (
          <FacetedFilter>
              ...
              >
                {filter.value && typeof filter.value === "string" ? (
                  ...
                  <div className="flex w-full justify-between align-center">
                    {filterField.placeholder ?? "Сонгох..."}
            ...
            >
              ...
              />
              <FacetedFilterList>
                <FacetedFilterEmpty>Сонголт олдсонгүй</FacetedFilterEmpty>
                <FacetedFilterGroup>
          ...
          <FacetedFilter>
            <FacetedFilterTrigger asChild>
              <Button
                ...
                aria-controls={`${inputId}-listbox`}
                className="h-8 w-full justify-start gap-2 rounded px-1.5 text-left text-muted-foreground hover:text-muted-foreground overflow-hidden"
              >
            ...
            >
              <FacetedFilterInput
                aria-label={`Search ${filterField?.label} options`}
                placeholder={filterField?.label ?? "Сонгох..."}
              />
              <FacetedFilterList>
                <FacetedFilterEmpty>Сонголт олдсонгүй</FacetedFilterEmpty>
                <FacetedFilterGroup>
                ...
                return (
                  <SortableItem key={filter.rowId} value={filter.rowId} asChild>
                    <div className="flex items-center gap-2">
                      <span className="hidden">{joinOperator}</span>
                      <Popover modal>
                        <PopoverTrigger asChild>
                          <Button
                            id={fieldTriggerId}
                      ...
                      >
                        <SelectTrigger
                          ...
                          className="h-8 w-32 rounded text-xs"
                        >
