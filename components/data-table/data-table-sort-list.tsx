...
export function DataTableSortList<TData>({
  ...
  function getSortTitle(id: string) {
    switch (id) {
      case "createdAt":
        return "Огноо";
      case "amount":
        return "Гүйлгээний дүн";
      default:
  ...
  return (
    ...
    >
      <Popover>
        ...
        >
          {uniqueSorting.length > 0 ? (
            <h4 className="font-medium leading-none">Эрэмбэ</h4>
          ) : (
            <div className="flex flex-col gap-1">
              <h4 className="font-medium leading-none">
                Эрэмбэлэлт байхгүй байна
              </h4>
              <p className="text-muted-foreground text-sm">
                Үр дүнгээ цэгцлэхийн тулд эрэмбэ нэмнэ үү.
              </p>
            </div>
          )}
